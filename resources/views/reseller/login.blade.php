...
@section('title', 'Reseller Login - Livekenceng')
...
<div class="min-h-screen bg-gradient-to-br from-orange-50 to-primary-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full">
        ...
        <div class="text-center mb-8">
            ...
            <h2 class="text-3xl font-bold text-gray-900">Reseller Login</h2>
            <p class="mt-2 text-gray-600">Livekenceng Partner Portal</p>
        </div>

        <!-- Login Form -->
        <div class="bg-white rounded-2xl shadow-xl p-8">
            <form method="POST" action="{{ route('reseller.login.post') }}">
                @csrf
